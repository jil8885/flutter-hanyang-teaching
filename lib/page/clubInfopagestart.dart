...
import 'package:flutter_hanyang_teaching/page/clubreviewpage.dart';
...
class _ClubInfoPageState extends State<ClubInfoPage> {
                ...
                onPressed: () {
                  if (_selectedCategory == "분과 선택") {
                    ...
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => ClubReviewPage(_selectedClub)));
                  }
                },
                color: Colors.amber,
  ...
  void _onSelectedCategory(String value) {
    setState(() {
      ...
      _clubs = List.from(_clubs)
        ..addAll(_infoModel.getClubsNamesByCategory(_selectedCategory));
    });
  }
